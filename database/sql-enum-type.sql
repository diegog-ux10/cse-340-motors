...
(
	inv_id integer NOT NULL GENERETED BY DEFAULT AS IDENTITY,
	inv_make characater varying NOT NULL,
	inv_model characater varying NOT NULL,
	inv_year characater(4) NOT NULL,
	inv_description text NOT NULL,
	inv_image characater varying NOT NULL,
	inv_thumbnail characater varying NOT NULL,
	inv_price numeric(9, 0) NOT NULL,
	inv_miles integer NOT NULL,
	inv_color characater varying NOT NULL,
	classification_id integer NOT NULL,
	CONSTRAINT inventory_pkey PRIMARY KEY (inv_id)
);

-- create relantionship between classification and inventory tables
